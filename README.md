...
* **RASC Model:** Introduction of the [**Rank-Aware Set-Compare (RASC)**](https://docs.google.com/document/d/1Ze9xveoCVXUF0Y0vd_T0NB_stgIxMnlMA_z24OVZQZA/edit?tab=t.0) model, a custom-engineered modification of the vanilla set-compare query protocol designed for refined preference elicitation.
* **Original Algorithm:** Implementation of a novel online algorithm based on the RASC model.
* [**The RASC - based NRMM Simulator**](https://necessarily-rank-maximal-matching-2.onrender.com/) takes input in an online fashion, visualizes each step of the algorithm and emits the NRMM
